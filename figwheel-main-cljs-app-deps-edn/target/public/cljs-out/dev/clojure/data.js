...
return cljs.core.reduce.call(null,(function (result,p__21136){
...
var vec__21140 = clojure.data.diff.call(null,va,vb);
var a_STAR_ = cljs.core.nth.call(null,vec__21140,(0),null);
var b_STAR_ = cljs.core.nth.call(null,vec__21140,(1),null);
var ab = cljs.core.nth.call(null,vec__21140,(2),null);
...
var clojure$data$EqualityPartition$equality_partition$dyn_21146 = (function (x){
...
return clojure$data$EqualityPartition$equality_partition$dyn_21146.call(null,x);
}
});
...
var clojure$data$Diff$diff_similar$dyn_21147 = (function (a,b){
...
return clojure$data$Diff$diff_similar$dyn_21147.call(null,a,b);
}
});
...
return (function (){var G__21151 = clojure.data.equality_partition.call(null,a);
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__21151__$1)].join('')));
