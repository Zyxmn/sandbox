...
try{return cljs.core.reduce.call(null,cljs.core._PLUS_,cljs.core.map.call(null,cljs.core._STAR_,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [(100000000000),(10000),(1)], null),cljs.core.map.call(null,(function (p1__21655_SHARP_){
return parseInt(p1__21655_SHARP_);
...
var c_21658 = (new goog.debug.Console());
var G__21657_21659 = c_21658.getFormatter();
goog.object.set(G__21657_21659,"showAbsoluteTime",false);

goog.object.set(G__21657_21659,"showRelativeTime",false);


goog.object.set(goog.debug.Console,"instance",c_21658);
...
figwheel.repl.logging.log_levels = cljs.core.into.call(null,cljs.core.PersistentArrayMap.EMPTY,cljs.core.map.call(null,cljs.core.juxt.call(null,clojure.string.lower_case,(function (p1__21660_SHARP_){
return goog.object.get(goog.debug.Logger.Level,p1__21660_SHARP_);
