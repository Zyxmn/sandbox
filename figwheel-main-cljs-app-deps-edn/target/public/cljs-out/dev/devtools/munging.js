...
var temp__5455__auto____$1 = (o19631["core"]);
if(cljs.core.truth_(temp__5455__auto____$1)){
var o19632 = temp__5455__auto____$1;
return (o19632["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__18707__auto__ = f;
return (o__18707__auto__["toString"]).call(o__18707__auto__);
} else {
return "";
}
}catch (e19633){var _ = e19633;
return "";
}});
...
try{var o__18707__auto___19635 = t;
(o__18707__auto___19635["cljs$lang$ctorPrWriter"]).call(o__18707__auto___19635,t,writer);
}catch (e19634){var __19636 = e19634;
}
...
var char_code = (function (){var o__18707__auto__ = (new String(char$));
return (o__18707__auto__["charCodeAt"]).call(o__18707__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__18707__auto__ = String;
return (o__18707__auto__["fromCharCode"]).call(o__18707__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__19637 = num_code;
switch (G__19637) {
case (1):
return (185);
...
var o__18707__auto__ = String;
return (o__18707__auto__["fromCharCode"]).call(o__18707__auto__,superscript_code);
});
/**
...
}catch (e19639){var _e__18714__auto__ = e19639;
return false;
}})())){
...
var vec__19640 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__19640,(0),null);
...
if(cljs.core.truth_(temp__5455__auto__)){
var o19643 = temp__5455__auto__;
var temp__5455__auto____$1 = (o19643["dependencies_"]);
if(cljs.core.truth_(temp__5455__auto____$1)){
var o19644 = temp__5455__auto____$1;
return (o19644["nameToPath"]);
} else {
return null;
}
} else {
...
(devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__19647){
var vec__19648 = p__19647;
var ns_detector = cljs.core.nth.call(null,vec__19648,(0),null);
...
var G__19654 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__19655 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__19654;
remaining_tokens = G__19655;
continue;
}
}
break;
...
/** @this {Function} */
(devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq19645){
var G__19646 = cljs.core.first.call(null,seq19645);
var seq19645__$1 = cljs.core.next.call(null,seq19645);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__19646,seq19645__$1);
}));
...
var vec__19659 = cljs.core.split_with.call(null,(function (p1__19658_SHARP_){
return cljs.core.not_EQ_.call(null,p1__19658_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__19659,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__19659,(1),null);
...
var vec__19665 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__19665,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__19665,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__19668 = cljs.core.rest.call(null,remaining_tokens);
var G__19669 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__19668;
name_tokens = G__19669;
continue;
} else {
...
var vec__19672 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__19672,(0),null);
var arity = cljs.core.nth.call(null,vec__19672,(1),null);
var vec__19675 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__19675,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__19675,(1),null);
var vec__19678 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__19678,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__19678,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__19678,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__19678,(3),null);
...
var vec__19684 = result;
var munged_ns = cljs.core.nth.call(null,vec__19684,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__19684,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__19684,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__19684,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__19684,(4),null);
var arity = cljs.core.nth.call(null,vec__19684,(5),null);
...
if(cljs.core.truth_(temp__5455__auto__)){
var vec__19688 = temp__5455__auto__;
var munged_name = cljs.core.nth.call(null,vec__19688,(0),null);
var args = cljs.core.nth.call(null,vec__19688,(1),null);
var vec__19691 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__19691,(0),null);
var name = cljs.core.nth.call(null,vec__19691,(1),null);
...
var G__19694 = (arity + (1));
var G__19695 = (function (){var temp__5455__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5455__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__19696){
var vec__19697 = p__19696;
var arity = cljs.core.nth.call(null,vec__19697,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__19697,(1),null);
...
var sorted_fns = cljs.core.map.call(null,(function (p1__19700_SHARP_){
return cljs.core.get.call(null,arities,p1__19700_SHARP_);
}),sorted_keys);
var sorted_infos = cljs.core.map.call(null,devtools.munging.parse_fn_info_deep,sorted_fns);
var sorted_args_lists = cljs.core.map.call(null,(function (p1__19701_SHARP_){
return cljs.core.drop.call(null,(2),p1__19701_SHARP_);
}),sorted_infos);
...
var args__4742__auto__ = [];
var len__4736__auto___19708 = arguments.length;
var i__4737__auto___19709 = (0);
while(true){
if((i__4737__auto___19709 < len__4736__auto___19708)){
args__4742__auto__.push((arguments[i__4737__auto___19709]));

var G__19710 = (i__4737__auto___19709 + (1));
i__4737__auto___19709 = G__19710;
continue;
} else {
}
break;
...
(devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__19704){
var vec__19705 = p__19704;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__19705,(0),null);
...
/** @this {Function} */
(devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq19702){
var G__19703 = cljs.core.first.call(null,seq19702);
var seq19702__$1 = cljs.core.next.call(null,seq19702);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__19703,seq19702__$1);
}));
...
var map__19713 = options;
var map__19713__$1 = (((((!((map__19713 == null))))?(((((map__19713.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__19713.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__19713):map__19713);
var include_ns_QMARK_ = cljs.core.get.call(null,map__19713__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__19713__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__19713__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__19713__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__19714 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__19714,(0),null);
var fn_name = cljs.core.nth.call(null,vec__19714,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__19714,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__19714,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__19714,(4),null);
...
var o__18707__auto__ = f;
return (o__18707__auto__["getBasis"]).call(o__18707__auto__);
});
/**
...
}catch (e19718){var _e__18714__auto__ = e19718;
...
var G__19719 = (obj[cljs.core.first.call(null,path)]);
var G__19720 = cljs.core.rest.call(null,path);
obj = G__19719;
path = G__19720;
continue;
} else {
...
var _STAR_ = (function (accum,p__19721){
var vec__19722 = p__19721;
var bit = cljs.core.nth.call(null,vec__19722,(0),null);
var protocol = cljs.core.nth.call(null,vec__19722,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__19725){
...
var selector = cljs.core.nth.call(null,vec__19726,(2),null);
...
var post_process = (function (p__19730){
var vec__19731 = p__19730;
var munged_name = cljs.core.nth.call(null,vec__19731,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__19731,(1),null);
...
var sorted_fns = cljs.core.map.call(null,(function (p1__19729_SHARP_){
return (obj[cljs.core.first.call(null,p1__19729_SHARP_)]);
}),sorted_matches);
