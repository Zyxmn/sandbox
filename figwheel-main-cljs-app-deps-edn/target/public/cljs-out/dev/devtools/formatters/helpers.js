...
var G__19736 = devtools.prefs.pref.call(null,v);
v = G__19736;
continue;
} else {
return v;
...
}catch (e19739){var _e__18714__auto__ = e19739;
return false;
}})();
...
}catch (e19743){var _e__18714__auto__ = e19743;
return false;
}})();
...
}catch (e19745){var _e__18714__auto__ = e19745;
return false;
}}
}
});
...
var vec__19747 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
...
return cljs.core.some.call(null,(function (p1__19750_SHARP_){
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__19750_SHARP_);
}),template);
});
