...
var len__4736__auto___19765 = arguments.length;
var i__4737__auto___19766 = (0);
while(true){
if((i__4737__auto___19766 < len__4736__auto___19765)){
args__4742__auto__.push((arguments[i__4737__auto___19766]));

var G__19767 = (i__4737__auto___19766 + (1));
i__4737__auto___19766 = G__19767;
continue;
} else {
}
break;
...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq19762){
...
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__19763,G__19764,seq19762__$2);
}));
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_.call(null,new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__19768_SHARP_){
return (!((cljs.core.meta.call(null,p1__19768_SHARP_) == null)));
})))){
...
var markup_db = cljs.core.get.call(null,map__19769__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e19773){var _e__18714__auto__ = e19773;
return false;
}})();
if(cljs.core.truth_(or__4126__auto__)){
return or__4126__auto__;
...
}catch (e19775){var _e__18714__auto__ = e19775;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__19777 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__19778 = devtools.formatters.state.get_current_state.call(null);
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__19778);

try{var map__19779 = opts;
...
var markup_db = cljs.core.get.call(null,map__19779__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__19777);
}});
...
var temp__5455__auto___19784 = devtools.formatters.state.get_managed_print_level.call(null);
if(cljs.core.truth_(temp__5455__auto___19784)){
var managed_print_level_19785 = temp__5455__auto___19784;
var _STAR_print_level_STAR__orig_val__19782_19786 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__19783_19787 = managed_print_level_19785;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__19783_19787);

try{devtools.formatters.state.update_current_state_BANG_.call(null,(function (p1__19781_SHARP_){
return devtools.formatters.state.set_managed_print_level.call(null,p1__19781_SHARP_,null);
}));

job_fn.call(null);
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__19782_19786);
}} else {
job_fn.call(null);
}
